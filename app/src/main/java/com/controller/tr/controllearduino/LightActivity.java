        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                if (pairedDevices.isEmpty()){
                    ...
                    Toast.makeText(LightActivity.this, ""+value, Toast.LENGTH_SHORT).show();
...
// TODO: 7/23/17 don't forget to add the slid for the application in the first page when it luanche for the fist time
    ...
    public void offOnBtn(){
        ...
        if (value==1){
          // change the image
            ...
            lamb.setImageResource(R.drawable.ic_light_off);
        ...
        }else
        {
            ...
            lamb.setImageResource(R.drawable.ic_light_on);
            // change the value
            value=1;
            // do what you want
    ...
    public class ProgressTask extends AsyncTask<Void, Void, Void> {
        ...
        public ProgressTask(LightActivity activity,BluetoothDevice device) {
